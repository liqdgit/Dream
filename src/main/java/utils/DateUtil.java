...
public class DateUtil {
     ...
     * 根据字符串时间,返回Calendar
     */
    public static Calendar getCalendar(String datetimeStr) throws ParseException {
     ...
     * @return
     */
    public static Date getFirstMonthFirstDay(Date startDate) throws ParseException {
     ...
     * @return
     */
    public static Date getFristMonthDay(Date startDate) throws ParseException {
        // 是不是
     ...
     * @return
     */
    public static Date getLastMonthDay(Date startDate) throws ParseException {
        // 是不是
        // int month = startDate.getMonth();
        Date monthEndDate = getMaxDateOfMonth(startDate);
        Date nextMonth = DateUtils.addMonths(startDate, -1);
     ...
     * @return
     */
    public static Date getLastMonthLastDay(Date startDate) throws ParseException {
     ...
     * @return
     */
    public static String getNextDay(String date, int num) throws ParseException {
     ...
     * @return
     */
    public static Date getNextMonthDay(Date startDate) throws ParseException {
        // 是不是
        // int month = startDate.getMonth();
        Date monthEndDate = getMaxDateOfMonth(startDate);
        Date nextMonth = DateUtils.addMonths(startDate, 1);
     ...
     */
    public static String StringPatternToPattern(String str, String pattern1, String pattern2) throws ParseException {
        Date dateTime = null;
        String productStr = "";
        try {
    ...
    */
     ...
     * @return 如2014-05-09
     */
    public static String getPreviousDay(int n, String patter) {
        Calendar calendar = Calendar.getInstance();
        calendar.add(Calendar.DATE, n); // 得到前一天
        Date date = calendar.getTime();
        SimpleDateFormat df = new SimpleDateFormat(patter);
	...
	/*public static void main(String[] args) {
        //String str = "2015-06-25";
        //System.out.println(getPreOneMonth("dd/MM/yyyy"));
        Date date=new Date();
        System.out.println(date);
        Date date2=DateUtil.dateAddMinute(date,30);
